...
public class ProductController {
    ...
    public ResponseEntity<String> deleteByPid(@PathVariable Long pid) {
    ...
    public ResponseEntity<Product> findByPid(@PathVariable Long pid) {
    ...
    public ResponseEntity<List<Long>> getPidsList() {
    ...
    public ResponseEntity<List<Product>> findBySupplierId(
            @PathVariable Long supplierId) {

        return new ResponseEntity<>(
                service.findBySupplierId(supplierId),
                HttpStatus.OK);
    }

    @GetMapping("/products/{productId}/supplier")
    public ResponseEntity<ProductDTO> getProductWithSupplier(
            @PathVariable Long productId) {

        return new ResponseEntity<>(
                service.getProductWithSupplier(productId),
                HttpStatus.OK);
    }
}