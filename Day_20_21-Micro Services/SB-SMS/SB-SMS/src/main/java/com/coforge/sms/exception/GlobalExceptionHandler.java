...
@RestControllerAdvice //to handles global Exception
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(SupplierNotFoundException.class) //to handle specific exception
	public ResponseEntity<?> handleDepartmentNotFoundException(SupplierNotFoundException e) {
